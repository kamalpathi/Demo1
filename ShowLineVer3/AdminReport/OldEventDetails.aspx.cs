...
{
    public partial class OldEventDetails : System.Web.UI.Page
    {
        int VenueID = 0;
        int pagesize = 10;
        ...
        private void GetEventList(int VenueID, int PageSize, int PageNumber, string searchBy)
        {
            try
            {
                ...
                _eventMasterModel = _getEventDetailsViewModel.GetHistoryEventDetailsProc(VenueID, PageSize, PageNumber, searchBy);
        ...
        protected void CountEventList(int VenueID, string searchBy)
        {
            ...
            {
                GetEventDetailsViewModel _getEventDetailsViewModel = new GetEventDetailsViewModel();
                int EventListCount = _getEventDetailsViewModel.CountHistoryEventDetails(VenueID, searchBy);
