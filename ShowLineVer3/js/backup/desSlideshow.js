...
(function(a){
    a.fn.desSlideshow = function (p) {
        ...
        if (focus) {
            ...
            function init() {
                g.css("width", slideshow_width + "px").css("height", slideshow_height + "px").css("position", "relative").css("border-top", "1px solid #CCCCCC").css("overflow", "hidden");
                g.find("a").css("color", "#b7b7b7");
                ...
                g.find(".switchBigPic").children("div").children("p").css("position", "absolute").css("padding", "15px 15px").css("margin", "0px").css("bottom", "0px").css("opacity", "0.8").css("background-color", "#000").css("color", "#FFF").css("font-size", "14px").css("width", "100%").css("line-height", "19px");
                g.find(".nav").css("width", thumbnail_width + "px").css("height", slideshow_height + "px").css("position", "absolute").css("right", "0px");
                g.find(".nav").children("li").css("height", "62px").css("background-image", "url(" + directory + "flashtext-bg.jpg)").css("line-height", "16px");
                g.find(".nav").children("li").children("a").css("text-decoration", "none").css("height", "62px").css("display", "block").css("padding", "15px 0 0 25px").css("font-size", "12px");
                g.find(".nav").children("li").css("margin-left", "0px");
                g.find(".switchBigPic").children("div").hide();
            }
            function showpic() {
                clearTimeout(v);
                g.find(".nav").children("li").css("background-image", "url(" + directory + "flashtext-bg.jpg)");
                ...
                g.find(".nav").children("li").eq(current).animate({ marginLeft: '-5px' }, "fast");
