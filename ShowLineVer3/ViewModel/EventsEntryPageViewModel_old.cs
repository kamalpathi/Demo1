...
namespace ShowLineVer3.ViewModel
{
    public class EventsEntryPageViewModel
    {
        ...
        private void GenerateBarCode(string EventSPID)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(ConnString))
        ...
        protected bool GenrateBarcode_Image(string Barcode_Value)
        {
            ...
            try
            {
                ...
                Image img = new Image();
                System.Drawing.Image imm = b.Encode(type, Barcode_Value, System.Drawing.Color.Black, System.Drawing.Color.White, 250, 60);
