                    ...
                    <div id="tab-nav1">   
                        <nav>
                            ...
                            <%--<li><a id="ViewEvent" href="#" onclick="LoadPage('viewevent.aspx',this)"><span>View Events</span></a></li>--%>
                             <li><a id="A1" href="#"><span>View Events</span></a>
                                <ul>
                                    <li><a href="#" onclick="LoadPage('viewevent.aspx',this)">Current Events</a></li>
                                    <li><a href="#" onclick="LoadPage('AdminReport/OldEventDetails.aspx',this)">Past Events</a></li>                                    
                                </ul>
                            </li>
                            ...
                            <li><a id="UserCreation" href="#" onclick="javascript:LoadPage('AdminList.aspx',this)"><span>Create User</span></a></li>
                            ...
                            <li><a id="Report" href="#"><span>Reports</span></a>
                                <ul>
                                    <li><a href="#" onclick="LoadPage('AdminReport/rptTransactionDetails.aspx',this)">Transaction Details</a></li>
                                    <li><a href="#" onclick="LoadPage('AdminReport/reportSalesReport.aspx',this)">Sales Report</a></li>
                                    <li><%--<a href="#" onclick="LoadPage('AdminReport/rptEventVenueWise.aspx',this)">Sales Report - Event Wise</a>--%></li>
                                </ul>
                            </li>
                            <li><a id="CustomerInfo" href="#"  onclick="LoadPage('AdminReport/CustomerDetails.aspx',this)"><span>Customer Info</span></a></li>
